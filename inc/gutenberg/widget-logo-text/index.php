...
add_action( 'init', function() {
    ...
    require_once 'inc/task_theme_widget_logo_text_render.php';
    register_block_type(
        ...
        [
            ...
            'render_callback' => 'task_theme_widget_logo_text_render', // The render callback
        ]
    );
});
